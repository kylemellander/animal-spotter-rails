class SightingsController < ApplicationController
  ...
  # GET /sightings.json
  def index
    @sightings = Sighting.all.order(date: :desc)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @sighting.save
        format.html { redirect_to sightings_path, notice: 'Sighting was successfully created.' }
  ...
  private
    ...
    def sighting_params
      params.require(:sighting).permit(:species_id, :date, :lat, :lng, :reporter, :notes)
    end
end
